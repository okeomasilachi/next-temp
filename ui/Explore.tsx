import { Button, Center, Container, Heading, Image, SimpleGrid, Text, VStack } from '@chakra-ui/react';
        ...
        <Container py={20}>
            ...
            <SimpleGrid gap={10} columns={{ base: 1, md: 2 }} my={20}>
                <Center>
                    <VStack>
                        ...
                        <Text my={10} textAlign={'justify'}>Easily schedule your next car wash with our simple online booking system. Choose from a range of services, select your preferred date and time, and confirm your appointment in just a few clicks. Enjoy a hassle-free experience with care care.</Text>
                        <Button alignSelf={'start'} justifySelf={'end'} colorScheme="white" borderColor={'black'} borderRightColor={'black'} borderBottomColor={'black'} textColor="blue.500" size="md" variant="outline">
                            Book Now
                        </Button>
                    </VStack>
                </Center>
            ...
            <Center>
                <VStack>
                    ...
                    <Heading my={10} size={'lg'}>WhatsApp Support</Heading>

...
const servicesData: Service[] = [
    ...
    },
    {
        ...
        description: 'Restore your car\'s finish and eliminate swirl marks and scratches.',
        category: 'Detailing',
        backgroundImage: 'https://via.placeholder.com/400x300'
    },
    {
        ...
        description: 'A thorough clean of your engine bay for a like-new appearance.',
        category: 'Detailing',
        backgroundImage: 'https://via.placeholder.com/400x300'
    },
    {
        ...
        description: 'Nourish and protect your car\'s leather interior for lasting beauty.',
        category: 'Interior',
        backgroundImage: 'https://via.placeholder.com/400x300'
    },
    {
        ...
        description: 'Crystal-clear windows for improved visibility and a flawless look.',
        category: 'Detailing',
        backgroundImage: 'https://via.placeholder.com/400x300'
    }
];
                ...
                <Flex justify="center" mb={8}>
                    <Menu>
                        ...
                        <MenuList>
                            ...
                            {Array.from(new Set(servicesData.map((service) => service.category))).map(
                                (category) => (
                                    <MenuItem
                                        key={category}
